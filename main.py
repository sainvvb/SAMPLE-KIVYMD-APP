...
class BMSApp(App):
    def build(self):
        ...
        self.current_label = Label(text='Current (A):', font_size=20, bold=True)
        ...
        self.voltage_label = Label(text='Voltage (V):', font_size=20, bold=True)
        ...
        current_layout = BoxLayout(orientation='horizontal', size_hint_y=None, height=40, spacing=10)
        ...
        voltage_layout = BoxLayout(orientation='horizontal', size_hint_y=None, height=40, spacing=10)
        ...
        temperature_layout = BoxLayout(orientation='horizontal', size_hint_y=None, height=40, spacing=10)
        ...
        soc_layout = BoxLayout(orientation='horizontal', size_hint_y=None, height=40, spacing=10)
        ...
        self.left_grid = GridLayout(cols=1, spacing=5, size_hint=(0.5, 1))  # Reduced width to 50%
        ...
        for i in range(1, 9):  # Starting serial number from 1 for 7 cells
            ...
            cell_layout = BoxLayout(orientation='horizontal', size_hint_y=None, height=40, spacing=10)
        ...
        self.right_grid = GridLayout(cols=1, spacing=5, size_hint=(0.5, 1))  # Reduced width to 50%
